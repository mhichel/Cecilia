...
from apps.Entidades.models import aplicacion, cargo, bodega, historico_creacion_persona, persona, eliminacion_aplicacion, creacion_aplicacion, usuario, historico_eliminacion_persona
